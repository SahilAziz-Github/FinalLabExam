...
{  
...

	{
        document.fm.phon.style.color="black";
		    document.getElementById("pho").innerHTML="Valid Valid Phone Number.";
...
{  
  ...
  var un = document.fm.email.value;
   ...
   if (un.indexOf('@') == -1 ||  un.indexOf('@') == 0) // if no @ then the string array will return -1 index
   {
         ...
         document.getElementById("eml").innerHTML="Invalid Email .";
...

           {
          	...
          	document.fm.email.style.color="black";
	         	document.getElementById("eml").innerHTML="Valid Valid Phone Number.";
...
<div style="border-radius: 5px; background-color: #f2f2f2; padding: 20px;">
  ...
  <form action="Reg2.php" method="post" id="fm" name="fm">
    ...
    <label for="fname"></label><b>First Namr:</b></label>
   ...
   <input style="width: 100%;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #ccc;border-radius: 4px;
    box-sizing: border-box;" type="text" id="uname" name="uname"    onkeyup="unamevad()"               placeholder="User Name....">
...
<select  name="utype">
  ...
  <option value="admin">Admin</option>
    ...
    cursor: pointer;float: left;" type="submit"  name="submit" onclick =" return validate() " onsubmit="success()"   value="Submit"><br><br><br>
